...
<ol class="breadcrumb">
<li class="breadcrumb-producto"><a href="/">Tienda</a></li>
<li class="breadcrumb-producto active" aria-current="page">Cart</li>
</ol>
</nav>
...
<div class="row">
<div class="col-lg-3">
<img src="Assets/Productos/{{ $producto->image }}" class="img-thumbnail"
width="200" height="200">
</div>
<div class="col-lg-5">
<p>
<b><a href="/index/{{ $producto->slug }}">{{ $producto->name
}}</a></b><br>
<b>Price: </b>${{ $producto->price }}<br>
<b>Sub Total: </b>${{ \Cart::get($producto->id)->getPriceSum() }}<br>
{{-- <b>With Discount: </b>${{
\Cart::get($producto->id)->getPriceSumWithConditions() }}--}}
</p>
</div>
<div class="col-lg-4">
<div class="row">
...
<li class="list-group-producto"><b>Total: </b>${{ \Cart::getTotal() }}</li>
</ul>
</div>
